...
Database::Database() : driver(get_driver_instance()) {
    ...
    try {
        ...
        try {
            ...
            stmt->execute("INSERT INTO `Author` VALUES "
                                  "(437396,'Arthur ','Conan Doyle'),"
                                  "(757230,'Enthoven',' R. E.'),"
                                  "(611936,'Homer',' '),"
                                  "(757230,'Jackson','A. M. T.'),"
                                  "(907419,'Jane','Austen'),"
                                  "(378249,'Lewis','Carroll'),"
                                  "(907411,'Rowling','Joanne'),"
                                  "(888811,'James','Madison'),"
                                  "(172111,'Rick','Riordan'),"
                                  "(123114,' Terry','Pratchett'),"
                                  "(989999,'David','Sedaris')");
            stmt->execute("UNLOCK TABLES");
            ...
            stmt->execute("INSERT INTO `Book` VALUES (123114,'Equal Rites',8,1),"
                                  "(172111,'The Battle of the Labyrinth',111,1),"
                                  "(378249,'Alice''s Adventures in Wonderland',11,1),"
                                  "(437396,'The Adventures of Sherlock Holmes',0,1),"
                                  "(611936,'The Iliad',21,1),"
                                  "(757230,'Folk Lore Notes. Vol. II',14,1),"
                                  "(888811,'The Mind of the Founder',11,0.9),"
                                  "(907411,'Harry Potter and the Deathly Hallows',100,0.5),"
                                  "(907419,'Equal Rites',10,0.9),(989999,'Naked',110,0.6)");
            stmt->execute("UNLOCK TABLES");
